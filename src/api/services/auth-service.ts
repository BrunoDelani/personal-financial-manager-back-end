...
import {
  IUserAutenticateInput,
  IUserAutenticateOutput,
...
class AuthService {
  async authenticate(
    payload: IUserAutenticateInput,
    ip: string,
    userAgent: string,
  ): Promise<IUserAutenticateOutput> {
  ...
  async refresh(refreshToken: string): Promise<string> {
    ...
    const response = await refreshTokenRepository.findByTokenHash(
